...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // FIREBASE CONFIG
  var config = {
  databaseURL: "login-e2e07",
  apiKey: "AIzaSyDrHwLBSDT01hTlRiL1W5S6eNt6trUkZwg",
  authDomain: "login-e2e07.firebaseapp.com",
  projectId: "login-e2e07",
  storageBucket: "login-e2e07.appspot.com",
  messagingSenderId: "196375667277",
  appId: "1:196375667277:web:8796a91316aa5ebec97204"
  };
